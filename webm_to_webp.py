...
class WebMToWebPConverter:
    ...
    def _extract_video_frames(self, video_path: str):
        ...
        while frame_count < total_frames and target_frame_count < (target_frames if self.preserve_timing or total_frames > 60 else total_frames):
            # Set frame position
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Convert WebM videos to animated WebP.",
